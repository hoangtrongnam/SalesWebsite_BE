...
namespace Services
{
    public class OrderServices : IServices<OrderRequestModel, int>
    {
            ...
            try
            {
                ...
                using (var context = _unitOfWork.Create())
                {
                    ...
                    else
                    {
                        ...
                        //5. Insert table notifications (NV)
        ...
        public ResultModel Delete(OrderRequestModel model, int OrderID)
        {
            try
            {
                ResultModel outModel = new ResultModel();
        ...
        public ResultModel Delete(int OderID)
        {
            throw new NotImplementedException();
        }

        public ResultModel Get(int orderID)
        {
            try
            {
                using (var context = _unitOfWork.Create())
        ...
        public ResultModel Update(OrderRequestModel item, int orderID)
        {
            try
            {
                ResultModel outModel = new ResultModel();
